...
def load_program_object_code(parsed_object_code_dict_list):
    memory_model_dictionary = initialize_memory()

    # Load object code into memory model

    return memory_model_dictionary


memory_model_dict = {}

parsed_object_code_dict_list = []
parsed_assembly_listing_dict_list = []
        ...
        match command.upper():
            case "L":
                try:
                    ...
                    parsed_assembly_listing_dict_list = sic_assembly_listing_parser(
