...
def assembler_pass_one(parsed_code_dict_list):
    # ASSEMBLER PASS ONE
    # STATUS
    ...
    # STATUS
    print_status("Pass one assembly complete")
...
def assembler_pass_two(parsed_code_dict_list, assembly_code_file_path):
    # ASSEMBLER PASS TWO
    # STATUS
    print_status("Beginning pass two assembly")
    ...
    # STATUS
    print_status("Object code file ready for writing", object_code_file_path)
    ...
    # STATUS
    print_status("Assembly listing file ready for writing", assembly_listing_file_path)
